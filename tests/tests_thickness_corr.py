...
from taturtle.thickness_correction import SliceThicknessCorrection
...
class TestThicknessCorr(unittest.TestCase):
    ...
    def test_sort_by_monotonically_increasing_z(self):
        ...
        sorted_pairs = SliceThicknessCorrection.sort_by_monotonically_increasing_z(
            pairs
        )
    ...
    def test_resample_info_attributes(self):
        ri = SliceThicknessCorrection.ResampleInfo(
